...
-- Change 'show_all' attribute in 'attributes_attribute' relation to TRUE if there are less than 10 options in
-- 'attributes_attributeoption' relation for each corresponding record in 'attributes_attribute'
select core_utils.update_show_options()
