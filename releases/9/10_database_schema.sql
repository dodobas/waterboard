ALTER TABLE features.changeset ADD changeset_type text default 'U';
ALTER TABLE features.changeset ADD metadata jsonb;
...
DROP FUNCTION core_utils.filter_attributes();
